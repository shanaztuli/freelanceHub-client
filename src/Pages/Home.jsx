      ...
      <div>
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <p className="text-center text-lg md:text-xl  mb-6 mx-2 md:mx-0">
            Stay ahead with the newest job opportunities on our platform!
            Discover the latest freelance projects, explore diverse categories,
            and connect with top employers to kickstart your next exciting
            venture.
          </p>
